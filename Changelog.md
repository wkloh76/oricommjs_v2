...
- Remove electron from dependencies at deskelectronjs which will cause electron-builder build faileure for deployment purpose. Completed on 2026-02-11
...
- Reaction.sj at compmgr engine which support load multi files from components "gui\json" side to combined relavant data and suite to wfexchange format. Completed on 2026-01-22
...
[1.1.8]: https://github.com/wkloh76/oricommjs_v2/releases/tag/1.1.8
...
- Optimize workflow engine design. Fully implement workflow engine to entire backend and frontend design.
...
- Move the startupinit module from atomic/atom to utils. Completed on 2026-01-01
- Completelly migration atom/smfetch and atom/csse to utils. Wait for test.
...
[1.1.6]: https://github.com/wkloh76/oricommjs_v2/releases/tag/1.1.6
